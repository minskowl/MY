...
namespace Savchin.Plugins
{
	...
	public class RemoteLoader : MarshalByRefObject
	{
		...
		{
		    Assembly owningAssembly = GetOwningAssembly(typeName);
        ...
        public MarshalByRefObject CreateInstance(string typeName)
        {
            ...
            MarshalByRefObject createdInstance = owningAssembly.CreateInstance(typeName) as MarshalByRefObject;
            if (createdInstance == null)
            {
                throw new ArgumentException("typeName must specify a Type that derives from MarshalByRefObject");
            }
	    ...
	    private Assembly GetOwningAssembly(string typeName)
	    {
