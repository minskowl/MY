...
namespace WatiN.Core
{
    ...
    public class IE : Browser
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IE"/> class.
        /// </summary>
        /// <param name="iwebBrowser2">The iweb browser2.</param>
        /// <param name="finishInitialization">if set to <c>true</c> [finish initialization].</param>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [load images].
        /// </summary>
        /// <value>
        ///   <c>true</c> if [load images]; otherwise, <c>false</c>.
        /// </value>
        public bool LoadImages
        {
            ...
            get
            {
                if (loadImages == null)
                {
                    using (RegistryKey ieKey = Registry.CurrentUser.CreateSubKey(@"Software\Microsoft\Internet Explorer\Main"))
                    {
                        var v = ieKey.GetValue("Display Inline Images");
                        loadImages = (v != null && (string)v == "yes");
                    }
            ...
            set
            {
                using (RegistryKey ieKey = Registry.CurrentUser.CreateSubKey(@"Software\Microsoft\Internet Explorer\Main"))
                {
                    ieKey.SetValue("Display Inline Images", value ? "yes" : "no");
                }
                loadImages = value;
            }
        }
