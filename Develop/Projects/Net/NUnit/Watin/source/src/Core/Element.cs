...
namespace WatiN.Core
{
    ...
    public class Element : Component
	{
        ...
        /// </summary>
        /// <param name="eventName">Name of the event.</param>
        /// <param name="waitForComplete">if set to <c>true</c> [wait for complete].</param>
        public virtual void FireEvent(string eventName, bool waitForComplete)
        {
            fireEvent(eventName, waitForComplete, null);
        }
		/// <summary>
