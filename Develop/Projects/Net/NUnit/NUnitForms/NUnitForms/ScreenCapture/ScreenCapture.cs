...
namespace NUnit.Extensions.Forms
{
    ...
    public class ScreenCapture
    {
        ...
        private Bitmap capture(Control window, Rectangle rc)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Please re-open your form.", "Capture failed", MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.ToString(), "Capture failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        public virtual void Save(String filename, ImageFormatHandler.ImageFormatTypes format)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Windows.Forms.MessageBox.Show(s, "Capture failed", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}