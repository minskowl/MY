...
{
    public class CategoryDropDownList : DropDownListEx
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            foreach (Category category in cat)
            {
                ...
                {
                    AddItem(category.Name, category.CategoryID.ToString());
        ...
        private void PrintCategory(int id, int level)
        {
            ...
            foreach (Category category in cat)
            {
                ...
                {
                    AddItem(StringUtil.Clone("|", level) + category.Name, category.CategoryID.ToString());
                    categories.Remove(category);
