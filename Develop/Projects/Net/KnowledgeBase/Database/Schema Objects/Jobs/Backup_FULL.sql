USE [msdb]
GO
/****** Object:  Job [WAMProdFull]    Script Date: 07/23/2007 08:23:23 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
DECLARE @Job_Name  nvarchar(100)
SELECT @Job_Name='KnowledgeBase_FULL'
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 07/23/2007 08:23:23 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Create full backup.', 
		@category_name=N'Database Maintenance', 
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Subplan]    Script Date: 07/23/2007 08:23:23 ******/
...
SELECT @Sql	=''BACKUP DATABASE [KnowledgeBase] TO  ['' + @DeviceName + ''] WITH NOFORMAT, NOINIT,   NAME = N'''''' + @Name + '''''', SKIP, REWIND, NOUNLOAD,  STATS = 10'';
EXEC(@Sql);		
		', 
