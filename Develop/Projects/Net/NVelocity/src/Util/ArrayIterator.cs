...
namespace org.apache.velocity.util {
    ...
    /// </author>
    /// <version> $Id: ArrayIterator.cs,v 1.2 2003/10/27 13:54:12 corts Exp $
    ///
    /// </version>
	...
	public ArrayIterator(System.Object array) {
	    ...
	    */
		...
		throw new System.ArgumentException("Programmer error : internal ArrayIterator invoked w/o array");
	    }
	...
	public virtual System.Object next() {
	    ...
	    */
	    ...
	    throw new System.Exception("No more elements: " + pos + " / " + size);
	}
