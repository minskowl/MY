...
namespace NVelocity.Runtime.Resource {
    ...
    /// </author>
    /// <version> $Id: ResourceManager.cs,v 1.3 2003/10/27 13:54:11 corts Exp $
    ///
    /// </version>
	...
	///
	/// </returns>
	Resource getResource(System.String resourceName, int resourceType, System.String encoding);
