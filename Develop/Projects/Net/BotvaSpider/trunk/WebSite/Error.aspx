...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="Server">
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="ViewDevelop" runat="server">
            <table cellpadding="0" cellspacing="0" border="0" style="height: 100%; width: 100%">
                <tr>
                    <td valign="top">
                        <br />
                        <bot:HeaderPage ID="ErrorPageHeader" runat="server">Error on page</bot:HeaderPage>
                        <br />
                        ...
                        <asp:Panel ID="RealExceptionPanel" runat="server" Width="100%" Visible="False">
                            <br />
                            <br />
                            <bot:HeaderParagraph ID="HeaderParagraph1" runat="server">Real Exception</bot:HeaderParagraph>
        ...
        <asp:View ID="ViewProduction" runat="server">
            <bot:HeaderPage ID="ErrorPageHeader1" runat="server">Error on page</bot:HeaderPage></br>
