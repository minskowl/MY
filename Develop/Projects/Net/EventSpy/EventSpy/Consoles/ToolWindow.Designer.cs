namespace Savchin.EventSpy.Consoles
{
    partial class ToolWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DockAreas = ((Savchin.Forms.Docking.DockAreas)(((((Savchin.Forms.Docking.DockAreas.Float | Savchin.Forms.Docking.DockAreas.DockLeft)
                        | Savchin.Forms.Docking.DockAreas.DockRight)
                        | Savchin.Forms.Docking.DockAreas.DockTop)
                        | Savchin.Forms.Docking.DockAreas.DockBottom)));
