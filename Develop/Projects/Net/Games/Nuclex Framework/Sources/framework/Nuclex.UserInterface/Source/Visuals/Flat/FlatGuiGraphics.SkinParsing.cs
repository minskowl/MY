...
namespace Nuclex.UserInterface.Visuals.Flat
{
    ...
    partial class FlatGuiGraphics
    {
        ...
        public void LoadSkin(IServiceProvider serviceProvider, string skinPath)
        {
                  ...
                  FileAccess.Read, FileShare.Read))
            {
                ...
                try
                {
                    LoadSkin(contentManager, skinStream);
                }
                catch (Exception )
                {
        ...
        /// <summary>
        /// Loads a skin from stream
        /// </summary>
        /// <param name="contentManager">The content manager.</param>
        /// <param name="skinStream">Stream containing the skin description</param>
        public void LoadSkin(ContentManager contentManager, Stream skinStream)
        {
      ...
      var skinDocument = XDocument.Load(skinStream);
            ...
            loadResources(contentManager, skinDocument);
        ...
        private void loadResources(ContentManager contentManager, XDocument skinDocument)
        {
            ...
            foreach (XElement element in resources.Descendants("font"))
            {
                ...
                SpriteFont spriteFont = contentManager.Load<SpriteFont>(contentPath);
            ...
            foreach (XElement element in resources.Descendants("bitmap"))
            {
                ...
                Texture2D bitmap = contentManager.Load<Texture2D>(contentPath);
