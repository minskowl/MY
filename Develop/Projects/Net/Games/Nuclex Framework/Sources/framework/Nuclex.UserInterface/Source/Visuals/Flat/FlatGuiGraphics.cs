...
namespace Nuclex.UserInterface.Visuals.Flat
{
    ...
    public partial class FlatGuiGraphics : IFlatGuiGraphics, IDisposable
    {
        ...
        private List<ContentManager> _contentManagers=new List<ContentManager>();
        #region struct Frame
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FlatGuiGraphics"/> class.
        /// </summary>
        /// <param name="contentManager">The content manager.</param>
        /// <param name="skinStream">The skin stream.</param>
        public FlatGuiGraphics(ContentManager contentManager, Stream skinStream)
            : this(contentManager.ServiceProvider)
        {
        ...
        public FlatGuiGraphics(IServiceProvider serviceProvider)
        {
