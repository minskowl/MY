...
namespace Savchin.WinApi.OleStorage
{
    internal sealed class Information
    {
        ...
        public static bool IsDate(object Expression)
        {
            ...
            return ((str != null) && DateTime.TryParse(str, out time));
        }
        ...
        {
            switch (VbName.Trim().ToUpperInvariant())
            {
                case "OBJECT":
        ...
        //    string pBstrDocString = null;
        //    string pBstrHelpFile = null;
        //    UnsafeNativeMethods.IProvideClassInfo info2 = VarName as UnsafeNativeMethods.IProvideClassInfo;
        //    if (info2 != null)
        //    {
        //        try
        //        {
