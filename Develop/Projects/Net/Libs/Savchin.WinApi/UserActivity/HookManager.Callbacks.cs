...
namespace Savchin.WinApi.UserActivity
{
    public static partial class HookManager
    {
        ...
        private static void EnsureSubscribedToGlobalMouseEvents()
        {
            ...
            if (s_MouseHookHandle == 0)
            {
                ...
                //install hook
                s_MouseHookHandle = User32.SetWindowsHookEx(
                    WH.WH_MOUSE_LL,
                    s_MouseDelegate,
        ...
        private static void ForceUnsunscribeFromGlobalMouseEvents()
        {
            ...
            {
                //uninstall hook
                bool result = User32.UnhookWindowsHookEx(s_MouseHookHandle);
        ...
        private static void EnsureSubscribedToGlobalKeyboardEvents()
        {
            ...
            if (s_KeyboardHookHandle == 0)
            {
                ...
                //install hook
                s_KeyboardHookHandle = User32.SetWindowsHookEx(
                    WH.WH_KEYBOARD_LL,
                    s_KeyboardDelegate,
                    Marshal.GetHINSTANCE(
                        Assembly.GetExecutingAssembly().GetModules()[0]),
        ...
        private static void ForceUnsunscribeFromGlobalKeyboardEvents()
        {
            ...
            {
                //uninstall hook
                bool success = User32.UnhookWindowsHookEx(s_KeyboardHookHandle);
                //reset invalid handle
