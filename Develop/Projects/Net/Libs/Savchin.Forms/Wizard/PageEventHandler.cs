	...
	public class PageEventArgs : EventArgs
	{
        ...
        public WizardPage Page
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("value", value, "The page you tried to set was not found in the wizard.");
                }
            }
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="PageEventArgs"/> is cancel.
        /// </summary>
