...
namespace Savchin.Forms.ListView
{
    ...
    internal class NativeMethods
    {
       ...
       [DllImport("user32.dll", CharSet = CharSet.Auto)]
        ...
        public static void ForceSubItemImagesExStyle(System.Windows.Forms.ListView list)
        {
        ...
        public static void SetSubItemImage(System.Windows.Forms.ListView list, int itemIndex, int subItemIndex, int imageIndex)
        {
        ...
        public static void SetColumnImage(System.Windows.Forms.ListView list, int columnIndex, SortOrder order, int imageIndex)
        {
        ...
        public static void SelectAllItems(System.Windows.Forms.ListView list)
        {
        ...
        public static void DeselectAllItems(System.Windows.Forms.ListView list)
        {
        ...
        public static void SetItemState(System.Windows.Forms.ListView list, int itemIndex, int mask, int value)
        {
            LVITEM lvItem = new LVITEM();
        ...
        public static bool Scroll(System.Windows.Forms.ListView list, int dx, int dy)
        {
        ...
        public static IntPtr GetHeaderControl(System.Windows.Forms.ListView list)
        {
