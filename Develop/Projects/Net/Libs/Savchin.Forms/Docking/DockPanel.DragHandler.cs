...
namespace Savchin.Forms.Docking
{
    partial class DockPanel
    {
        ...
        private abstract class DragHandlerBase : NativeWindow, IMessageFilter
        {
            ...
            {
                if (m.Msg == (int)WM.WM_MOUSEMOVE)
                    OnDragging();
                else if (m.Msg == (int)WM.WM_LBUTTONUP)
                    EndDrag(false);
                else if (m.Msg == (int)WM.WM_CAPTURECHANGED)
                    EndDrag(true);
                else if (m.Msg == (int)WM.WM_KEYDOWN && (int)m.WParam == (int)Keys.Escape)
                    EndDrag(true);
            ...
            {
                if (m.Msg == (int)WM.WM_CANCELMODE || m.Msg == (int)WM.WM_CAPTURECHANGED)
                    EndDrag(true);
        ...
        private abstract class DragHandler : DragHandlerBase
        {
            ...
            {
                if ((m.Msg == (int)WM.WM_KEYDOWN || m.Msg == (int)WM.WM_KEYUP) &&
