...
dragContext.prototype.ind=function(downMoving){
...
dhtmlXGridObject.prototype._dragRoutine=function(c){
 c.uid().tobj.addRow(c.nid,c.data(),c.ind(this._downMoving),c.pid(),c.img());
...
if (htmlObject.parentNode.rowIndex > shtmlObject.parentNode.rowIndex)
 this._downMoving = true;
else
