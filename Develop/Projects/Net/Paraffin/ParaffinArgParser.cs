...
namespace Wintellect.Paraffin
{
    internal class ParaffinArgParser : ArgParser
    {
        ...
        /// </summary>
        /// <value>The component group.</value>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [generate root dir].
        /// </summary>
        /// <value><c>true</c> if [generate root dir]; otherwise, <c>false</c>.</value>
        public Boolean GenerateRootDir { get; set; }
        ...
        private const string k_DISKID = "di";
        ...
        private const string k_COMPONENT_GROUP = "compgr";
        private const string k_COMPONENT_GROUP_SHORT = "cg";
        private const string k_GENERATE_ROOT = "genroot";
        private const string k_GENERATE_ROOT_SHORT = "gr";
        #endregion
        ...
        public ParaffinArgParser()
            : base(new String[] { k_HELP_QUESTION   , k_HELP_SHORT , k_HELP ,
                                     ...
                                     k_WIN64 },
                     new String[] { k_DIR_SHORT        , k_DIR ,k_DISKID,
                                     ...
                                     k_COMPONENT_GROUP  , k_COMPONENT_GROUP_SHORT},
                     true)
        {
