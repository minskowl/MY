...
namespace ExtendedWebBrowser2
{
    ...
    public class ExtendedWebBrowser : System.Windows.Forms.WebBrowser
    {
        ...
        public object InvokeScript(string function, object[] args)
        {
            return this.Document == null ? null : Document.InvokeScript(function, args);
        }

        public object InvokeScript(string function, object arg)
        {
            return Document == null ? null : Document.InvokeScript(function, new[] { arg });
        }

        public object InvokeScript(string function)
        {
            return Document == null ? null : Document.InvokeScript(function);
        }
        ...
        {
            public WebBrowserSiteEx(WebBrowser host)
                : base(host)
            {
            }
            ...
            public int Idispatch_Invoke_Handler()
            {
                ...
                return (int)(BrowserOptions.NoActiveXDownload | BrowserOptions.None);
            }
