...
namespace EffectiveSoft.SilverlightDemo.Core
{
    public class ConverterColor
    {
        ...
        public static Color? ToColor(string htmlColor)
        {
            ...
            {
                if ((htmlColor[0] == '#') && ((htmlColor.Length == 7) || (htmlColor.Length == 4) || (htmlColor.Length == 9)))
                {
                    if (htmlColor.Length == 9)
                    {
                        empty = Color.FromArgb( Convert.ToByte(htmlColor.Substring(1, 2), 0x10), Convert.ToByte(htmlColor.Substring(3, 2), 0x10), Convert.ToByte(htmlColor.Substring(5, 2), 0x10), Convert.ToByte(htmlColor.Substring(7, 2), 0x10));
                    }
                    else if (htmlColor.Length == 7)
                    {
                        empty = Color.FromArgb(255,Convert.ToByte(htmlColor.Substring(1, 2), 0x10), Convert.ToByte(htmlColor.Substring(3, 2), 0x10), Convert.ToByte(htmlColor.Substring(5, 2), 0x10));
                    }
                    else
                    {
                        ...
                        empty = Color.FromArgb(255,Convert.ToByte(str + str, 0x10), Convert.ToByte(str2 + str2, 0x10), Convert.ToByte(str3 + str3, 0x10));
                    }
                }
                //if (empty==null && string.Equals(htmlColor, "LightGrey", StringComparison.OrdinalIgnoreCase))
                //{
                //    empty = Color;
                //}
                //if (empty == null)
