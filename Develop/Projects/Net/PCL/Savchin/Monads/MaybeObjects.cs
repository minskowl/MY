...
namespace Savchin.Core.Monads
{
    ...
    public static class MaybeObjects
    {
        ...
        /// <returns></returns>
        public static TCast Do<TCast>(this object source, Action<TCast> action)
            where TCast : class
        {
            return (source as TCast).Do(action);
        }
        ...
        public static TResult Return<TSource, TResult>(this TSource source, Func<TSource, TResult> action, TResult defaultValue)
                where TSource : class
        {
            return source != null ? action(source) : defaultValue;
        }
        ...
        public static TSource If<TSource>(this TSource source, Func<TSource, bool> condition)
                where TSource : class
        {
            return source != null && (condition(source)) ? source : null;
        }
        ...
        public static TSource IfNot<TSource>(this TSource source, Func<TSource, bool> condition)
                where TSource : class
        {
            return (source != null) && (condition(source) == false) ? source : null;
        }
