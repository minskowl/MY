...
namespace Savchin.Core.Monads
{
    public static class ArgumentCheck
    {
        ...
        /// <exception cref="System.ArgumentException">Parameter is empty</exception>
        public static string CheckNullOrEmpty(this string source, string argumentName)
        {
            if (source == null)
            {
                throw new ArgumentNullException(argumentName);
            ...
            {
                throw new ArgumentException("Parameter is empty", argumentName);
            }
