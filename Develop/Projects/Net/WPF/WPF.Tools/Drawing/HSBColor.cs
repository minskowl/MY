...
namespace Savchin.Wpf.Drawing
{
    ...
    public struct HSBColor
    {
        ...
        /// <returns></returns>
        public static  Color FromHSB(int alpha, int hue, int saturation, int black)
        {
            float r = black;
            float g = black;
            float b = black;
        ...
        {
            return FromHSB(hsbColor.A,hsbColor.h, hsbColor.s, hsbColor.b);
        }

        public static HSBColor FromColor(Color color)
        {
            var ret = new HSBColor(0, 0, 0);
