        ...
        public static Solution OpenSolution
        {
            ...
            set { 
                ...
                try
                {
                    ...
                    if (FileUtility.IsValidPath(file) && System.IO.File.Exists(file))
                    {
                        try
                        {
                ...
                if (openSolution != null)
                {
                    ...
                    if (found == false)
                    {
                        ...
                        else if (res == 1)
                        {
                            ...
                            try
                            {
                                System.IO.File.Copy(solutionFile, Path.ChangeExtension(solutionFile, ".old.sln"), true);
                            }
                            catch (IOException) { }
                        }
                        else
