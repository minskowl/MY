...
namespace Savchin.CodeEditor
{
    ...
    public class AvalonEditDocumentAdapter : IDocument
    {
        ...
        public void Replace(int offset, int length, string newText, ICSharpCode.AvalonEdit.Document.AnchorMovementType defaultAnchorMovementType)
        {
            document.Replace(offset, length, newText);
        }
        ...
        sealed class AnchorAdapter : ITextAnchor
        {
            ...
            public AnchorMovementType MovementType
            {
                get
                {
                    return (AnchorMovementType)anchor.MovementType;
                }
                set
                {
