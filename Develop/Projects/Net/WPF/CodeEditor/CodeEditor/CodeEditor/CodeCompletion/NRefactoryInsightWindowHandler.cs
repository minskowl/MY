...
namespace Savchin.CodeEditor.CodeCompletion
{
    public class NRefactoryInsightWindowHandler : IInsightWindowHandler
    {
        ...
        public NRefactoryInsightWindowHandler(SupportedLanguage language)
        {
            ...
            {
                eofToken = Tokens.EOF;
                commaToken = Tokens.Comma;
                openParensToken = Tokens.OpenParenthesis;
                closeParensToken = Tokens.CloseParenthesis;
                openBracketToken = Tokens.OpenSquareBracket;
                closeBracketToken = Tokens.CloseSquareBracket;
                openBracesToken = Tokens.OpenCurlyBrace;
                closeBracesToken = Tokens.CloseCurlyBrace;
                statementEndToken = Tokens.Semicolon;

                languageProperties = LanguageProperties.CSharp;
            }
            else
            {
                eofToken = ICSharpCode.NRefactory.Parser.VB.Tokens.EOF;
                commaToken = ICSharpCode.NRefactory.Parser.VB.Tokens.Comma;
                openParensToken = ICSharpCode.NRefactory.Parser.VB.Tokens.OpenParenthesis;
                closeParensToken = ICSharpCode.NRefactory.Parser.VB.Tokens.CloseParenthesis;
                openBracketToken = -1;
                closeBracketToken = -1;
                openBracesToken = ICSharpCode.NRefactory.Parser.VB.Tokens.OpenCurlyBrace;
                closeBracesToken = ICSharpCode.NRefactory.Parser.VB.Tokens.CloseCurlyBrace;
                statementEndToken = ICSharpCode.NRefactory.Parser.VB.Tokens.EOL;
