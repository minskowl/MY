...
{
    public class BubbleField : IEnumerable<Bubble>
    {
        ...
        {
            var bubble = new Bubble { Color = color };
        ...
        {
            List<Bubble> bub = new List<Bubble>();
        ...
        {
            return (BubbleColor)Randomizer.GetIntegerBetween(1, 6);
        }
